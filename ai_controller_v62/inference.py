...
class Predictor():
	def __init__(self):
		self.model_dir = r"D:\lincode\yolo\ai_controller_v62"
		self.weights_path =r'D:\lincode\europe\fiasa\weights\fiasa_crack_medium_2\exp\weights\best.pt'
		self.image_size = 640
		self.common_confidence = 0.25
	...
	def run_inference_hub(self,model, image):
		...
		return image, labels_, coordinates
